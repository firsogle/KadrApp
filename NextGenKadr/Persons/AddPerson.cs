...
namespace NextGenKadr
{
    public partial class AddPerson : Form
    {
        ...
        private void Button_Ok_Click(object sender, EventArgs e)
        {
            ...
            connection.Внести_сведения_об_образовании(TabNumber, Наименование_документа_Box.Text, Номер_образование_Box.Text,  Серия_образование_Box.Text, Наименование_учебного_заведения_Box.Text, Квалификация_Box.Text, Специальность_Box.Text);
            connection.Внести_cведения_о_послевузовском_образовании(TabNumber, Название_документа_Box.Text, Документ_Num_Box.Text, Наименование_учебного_заведения_После_Box.Text, Направление_Box.Text, Ученая_степень_Box.Text);
            ...
            connection.Внести_cведения_о_заработной_плате(TabNumber, Должность_Box.Text, Надбавка_Box.Text, Категория_Box.Text, Оклад_Box.Text, Ставка_Box.Text, Стаж_работы_Box.Text);
