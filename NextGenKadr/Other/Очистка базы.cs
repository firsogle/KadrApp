...
namespace NextGenKadr
{
    public partial class Settings : Form
    {
        ...
        private void Удалить_сотрудников_Click(object sender, EventArgs e)
        {
            ...
            connection.Получить_сведения_из_базы_данных("delete from [Аттестация]");
            connection.Получить_сведения_из_базы_данных("delete from [Награды и почетные звания]");
            connection.Получить_сведения_из_базы_данных("delete from [Приём и переводы на работу]");
            connection.Получить_сведения_из_базы_данных("delete from [Профессиональная переподготовка]");
            ...
            connection.Получить_сведения_из_базы_данных("delete from [Сведения о принятых на работу]");
            connection.Получить_сведения_из_базы_данных("delete from [Сведения об образовании]");
            connection.Получить_сведения_из_базы_данных("delete from [Сведения паспорта]");
            connection.Получить_сведения_из_базы_данных("delete from [Социальные льготы]");
            connection.Получить_сведения_из_базы_данных("delete from [Стаж работы]");
            connection.Получить_сведения_из_базы_данных("delete from [Сведения заграниченого паспорта]");
